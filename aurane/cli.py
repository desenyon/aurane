...
if USE_ENHANCED:
    ...
    def main():
        ...
        parser = argparse.ArgumentParser(
            prog='aurane',
            description='Aurane ML DSL - Transpile .aur files to Python'
        )
        ...
        compile_parser = subparsers.add_parser(
            'compile',
            help='Compile an Aurane file to Python'
        )
        ...
        run_parser = subparsers.add_parser(
            'run',
            help='Compile and run an Aurane file'
        )
        ...
        run_parser.add_argument(
            '--keep-temp',
            action='store_true',
            help='Keep the temporary compiled Python file'
        )
