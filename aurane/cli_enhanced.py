                ...
                if cmd_name in ('exit', 'quit', 'q'):
                    ...
                    if not cmd_args:
                        ...
                        try:
                            ...
                            console.print(f"[green][OK][/green] Loaded {len(code_buffer)} lines from {cmd_args}")
...
Examples:
  ...
  aurane interactive
    ...
    typecheck_parser.add_argument('--verbose', '-v', action='store_true', help='Show inferred types')
    ...
    profile_parser.add_argument('--batch-size', type=int, default=1, help='Batch size for memory calculation')
    profile_parser.add_argument('--detailed', '-d', action='store_true', help='Show layer-by-layer details')
    ...
    optimize_parser.add_argument('--level', '-O', type=int, default=1, choices=[0, 1, 2], help='Optimization level')
