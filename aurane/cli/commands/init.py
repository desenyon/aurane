...
def cmd_init(args):
    ...
    try:
        ...
        if project_dir.exists() and any(project_dir.iterdir()):
            console.print(f"[red]Error: Directory '{project_name}' already exists and is not empty.[/red]")
            return 1
...
"""
        ...
        # Print success
        console.print(f"[green][OK][/green] Project created at [bold]{project_dir.absolute()}[/bold]")
