...
class TestExperimentNode:
    ...
    def test_experiment_creation(self):
        ...
        exp = ExperimentNode(name="MyExperiment", config={"seed": 42, "device": "auto"})
...
class TestDatasetNode:
    ...
    def test_dataset_creation(self):
        ...
        dataset = DatasetNode(
            name="mnist", source="torchvision.datasets.MNIST", config={"batch": 32}
        )
...
class TestModelNode:
    ...
    def test_model_creation(self):
        ...
        model = ModelNode(name="TestNet", config={"input_shape": (3, 32, 32)})
    ...
    def test_model_with_forward_block(self):
        ...
        model = ModelNode(name="Net", forward_block=forward)
...
class TestTrainNode:
    ...
    def test_train_creation(self):
        ...
        train = TrainNode(model_name="Net", dataset_name="data", config={"epochs": 10, "lr": 0.001})
    ...
    def test_train_optimizer_config(self):
        ...
        train = TrainNode(
            model_name="Net",
            dataset_name="data",
            config={"optimizer": "adam", "lr": 0.001, "weight_decay": 0.0001},
        )
...
class TestLayerOperation:
    ...
    def test_layer_operation_creation(self):
        ...
        op = LayerOperation(
            operation="conv2d", args=[32], kwargs={"kernel": 3, "padding": 1}, activation="relu"
        )
...
class TestComplexAST:
    ...
    def test_complete_program(self):
        ...
        program.datasets.append(DatasetNode("mnist", "torchvision.datasets.MNIST", {"batch": 32}))
        ...
        program.trains.append(TrainNode("Net", "mnist", {"epochs": 10, "lr": 0.001}))
